...
#include "score/mw/com/impl/skeleton_base.h" // Ensure this is included for SkeletonBaseView

score::Result<std::unique_ptr<score::mw::com::impl::GenericSkeletonEventBinding>> score::mw::com::impl::GenericSkeletonEventBindingFactoryImpl::Create(SkeletonBase& parent, std::string_view event_name, const SizeInfo& size_info) noexcept
{
